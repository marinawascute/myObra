...
install_xcframework "${PODS_ROOT}/../../node_modules/expo-structured-headers/ios/EXStructuredHeaders.xcframework" "EXStructuredHeaders" "framework" "ios-arm64_x86_64-simulator" "ios-arm64"
